...
<div id="faq" class="bg-white rounded-xl shadow-xl overflow-hidden mb-10 fade-in">
    ...
    <div class="p-6">
        <div class="accordion" id="faqAccordion">
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden mb-10 fade-in">
                <div class="bg-gradient-to-r from-indigo-800 to-indigo-600 p-6">
                    <h3 class="text-2xl font-bold text-white flex items-center">
                        <i class="fas fa-headset mr-3"></i> Need More Help?
                    </h3>
                    <p class="text-indigo-100 text-sm mt-2">Our support team is ready to assist you</p>
                </div>
                
                <div class="p-6">
                    <div class="flex flex-col md:flex-row gap-6">
                        <div class="md:w-1/2">
                            <h4 class="text-xl font-semibold text-indigo-800 mb-4">Contact Support</h4>
                            <form id="supportForm" class="space-y-4">
                                <div class="form-group">
                                    <label for="supportSubject" class="block text-gray-700 mb-2">Subject</label>
                                    <select id="supportSubject" class="form-select w-full rounded-lg border-gray-300">
                                        <option value="">Select a topic</option>
                                        <option value="account">Account Issues</option>
                                        <option value="matching">Matching Algorithm</option>
                                        <option value="sponsors">Sponsor Communication</option>
                                ...
                                <div class="form-group">
                                    <label for="supportMessage" class="block text-gray-700 mb-2">Your Message</label>
                                    <textarea id="supportMessage" rows="4" class="form-control w-full rounded-lg border-gray-300" placeholder="Describe your issue or question in detail"></textarea>
                                </div>
                                
                                <div class="text-right">
                                    <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-lg transition-colors">
                        ...
                        <div class="md:w-1/2 bg-indigo-50 rounded-lg p-5">
                            <h4 class="text-xl font-semibold text-indigo-800 mb-4">Additional Resources</h4>
                            <ul class="space-y-3">
                                <li class="flex">
                                    <div class="flex items-center justify-center bg-indigo-100 text-indigo-600 rounded-lg min-w-[48px] h-12 mr-4">
                                        <i class="fas fa-play-circle text-xl"></i>
                                    </div>
                                    <div>
                                        <h5 class="font-medium">Video Tutorials</h5>
                                        <p class="text-sm text-gray-600">Step-by-step guides to using SponsMe effectively</p>
                                        <a href="#" class="text-indigo-600 hover:text-indigo-800 text-sm">Watch videos</a>
                                    </div>
                                </li>
                                <li class="flex">
                                    <div class="flex items-center justify-center bg-indigo-100 text-indigo-600 rounded-lg min-w-[48px] h-12 mr-4">
                                    ...
                                    <div>
                                        <h5 class="font-medium">Knowledge Base</h5>
                                        <p class="text-sm text-gray-600">Comprehensive articles and guides</p>
                                        <a href="#" class="text-indigo-600 hover:text-indigo-800 text-sm">Browse articles</a>
                                    </div>
                                </li>
                                <li class="flex">
                                    <div class="flex items-center justify-center bg-indigo-100 text-indigo-600 rounded-lg min-w-[48px] h-12 mr-4">
                                    ...
                                    <div>
                                        <h5 class="font-medium">Community Forum</h5>
                                        <p class="text-sm text-gray-600">Connect with other organizers and share tips</p>
                                        <a href="#" class="text-indigo-600 hover:text-indigo-800 text-sm">Join discussion</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
