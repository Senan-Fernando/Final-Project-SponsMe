...
<head>
    ...
    <style>
        /* Custom CSS for sidebar and card adjustments */
        .sidebar {
            width: 314px; /* Fixed width for sidebar */
        ...
        .main-content {
            margin-left: 250px; /* Margin to account for sidebar */
            padding: 20px;
            width: calc(100% - 250px); /* Adjust width */
        }

        .summary-card {
            max-width: 800px; /* Smaller width for summary card */
            margin: 0 auto; /* Center the card */
        }

        .revenues-card {
            max-width: 800px; /* Smaller width for revenues card */
...
<body class="bg-gray-100 min-h-screen">
    ...
    <!-- Sidebar -->
    <div class="sidebar bg-gradient-to-b from-blue-900 to-blue-800 text-white p-6 shadow-2xl">
        <!-- Logo and Brand -->
    ...
    <div class="main-content">
        ...
        <div class="summary-card bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        <!-- Event Revenues Section -->
        <div class="revenues-card bg-blue-100 rounded-lg shadow-lg p-6">
            <h3 class="text-2xl font-bold text-black mb-6">Event Revenues from Sponsors</h3>
