        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form>
                ...
                <div class="flex flex-col sm:flex-row justify-between gap-4 mt-6">
                    <button type="button" onclick="window.location.href='SponsEdit.php'" class="btn btn-primary w-full sm:w-1/3">Edit Profile</button>
                    <button type="button" onclick="window.location.href='RegSpons.php'" class="btn btn-danger w-full sm:w-1/3">Delete Profile</button>
                </div>
            </form>
        </div>
    </div>
