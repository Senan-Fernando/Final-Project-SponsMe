...
<body class="bg-white">
    ...
    <nav class="bg-blue-800 p-4 flex justify-between items-center text-white sticky top-0 z-50 shadow-lg">
        ...
        <div class="flex space-x-8">
            ...
            <?php if (isset($_SESSION['userId'])): ?>
                ...
                ?>
                <a href="<?= $profileLink ?>" class="nav-link text-white text-sm sm:text-base">BACK TO PROFILE</a>
                <a href="../Controller/Logout.php" class="nav-link text-white text-sm sm:text-base">LOGOUT</a>
            <?php else: ?>
    ...
    <section id="how-it-works" class="bg-gray-100">
        <div class="text-center px-4">
            ...
            <p class="text-gray-700 text-sm sm:text-base max-w-2xl mx-auto">
                Simply sign up, create your profile, and start exploring sponsorship opportunities tailored to your
                needs. Whether you're an organizer or a sponsor, our platform is here to help you succeed.
            </p>
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
